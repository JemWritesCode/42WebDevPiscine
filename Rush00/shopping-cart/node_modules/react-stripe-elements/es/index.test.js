...
describe('index', function () {
  ...
  describe('errors', function () {
    ...
    describe('handleCardPayment', function () {
      it('should throw if no Slient Secret is specified', function () {
        var Checkout = WrappedCheckout(function (props) {
      ...
      it('should throw if no card element is present and no elmenent or payment data is passed in', function () {
        var Checkout = WrappedCheckout(function (props) {
          return props.stripe.handleCardPayment('client_secret');
        });
        var app = (0, _enzyme.mount)(_react2.default.createElement(
        ...
        expect(function () {
          return app.find('form').simulate('submit');
        }).toThrowError(/Could not find a CardElement or CardNumberElement/);
      });
    });
